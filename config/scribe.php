...
return [
    ...
    'title' => 'Haraj API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API documentation for Haraj mobile and web applications. Includes authentication, OTP verification, and user management.',
